pub const IThreadPoolStatics = extern struct {
    ...
    pub const VTable = extern struct {
        ...
        RunAsyncWithPriorityAndOptions: *const fn(self: *anyopaque, handler: *WorkItemHandler, priority: WorkItemPriority, options: WorkItemOptions, _r: **IAsyncAction) callconv(.winapi) HRESULT,
    };
};
...
pub const IThreadPoolTimerStatics = extern struct {
    ...
    pub const VTable = extern struct {
        ...
        CreatePeriodicTimerWithDestroyed: *const fn(self: *anyopaque, handler: *TimerElapsedHandler, period: TimeSpan, destroyed: *TimerDestroyedHandler, _r: **ThreadPoolTimer) callconv(.winapi) HRESULT,
        CreateTimerWithDestroyed: *const fn(self: *anyopaque, handler: *TimerElapsedHandler, delay: TimeSpan, destroyed: *TimerDestroyedHandler, _r: **ThreadPoolTimer) callconv(.winapi) HRESULT,
    };
};
