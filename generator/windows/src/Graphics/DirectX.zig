pub const DirectXAlphaMode = enum(i32) {
    Unspecified = 0,
    Premultiplied = 1,
    Straight = 2,
    Ignore = 3,
};
pub const DirectXColorSpace = enum(i32) {
...
pub const DirectXPixelFormat = enum(i32) {
    Unknown = 0,
...
pub const DirectXPrimitiveTopology = enum(i32) {
    Undefined = 0,
    PointList = 1,
    LineList = 2,
    LineStrip = 3,
...
pub const Direct3D11 = @import("./DirectX/Direct3D11.zig");
